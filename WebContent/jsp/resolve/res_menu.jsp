							...
							<TBODY>
								<TR>
									<TD class=mainMenu onClick="MenuDisplay('table_1');"><SPAN
										class=span id=table_1Span>＋</SPAN> 服务器地址管理</TD>
								</TR>
								<TR>
									<TD>
										<TABLE id=table_1 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath}/jsp/infores/add.jsp" 
														target=main>－ 服务器地址解析</A></TD>
												</TR>
												<TR> 
													<TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath}/ManufinfoAction_list"
														target=main>－ 服务器地址查询</A></TD>
												</TR>
								...
								<TR>
									<TD class=mainMenu onClick="MenuDisplay('table_2');"><SPAN
										class=span id=table_2Span>＋</SPAN> 节点信息管理</TD>
								</TR>
								<TR>
									<TD>
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath}/jsp/linkman/add.jsp"
														target=main>－ 节点信息注册</A></TD>
												</TR>
												<TR>
													<TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath}/NodeinfoAction_list"
								...
								<TR>
									<TD class=mainMenu onClick="MenuDisplay('table_5');"><SPAN
										class=span id=table_5Span>＋</SPAN> 服务器信息管理</TD>
								</TR>
								<TR>
									<TD>
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2 href="#"
														target=main>－AIRS地址注册</A></TD>
												</TR>
												<TR>
													<TD class=menuSmall><A class=style2 href="#"
														target=main>－SLIRS地址注册</A></TD>
												</TR>

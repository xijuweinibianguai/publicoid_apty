...
<BODY>
	<FORM id=form2 name=form2 action="${pageContext.request.contextPath }/ManufinfoAction_add" method=post >
				...
				<TR>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						<TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
							<TR>
								<TD class=manageHead>当前位置：生产厂商信息注册 &gt; 生产厂商信息注册</TD>
							</TR>
							<TR>
								<TD height=2></TD>
							</TR>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							...
							<TR>
								<td>生产厂家公司全名：</td>
								<td>
								<INPUT class=textbox  style="WIDTH: 180px" maxLength=50 name="manuf_name" id="manuf_name" onfocus="showTips('manuf_name','生产厂家公司全名必填！')" onblur="check3()"><span id="manuf_namespan"></span>
								</td>
								<td>公司地址：</td>
								<td>
								<INPUT class=textbox id="manuf_addrs" style="WIDTH: 180px" maxLength=50 name="manuf_addrs" onfocus="showTips('manuf_addrs','公司地址必填！')" onblur="check3()"><span id="manuf_addrsspan"></span>
								</td>
							</TR>
							...
							<TR>
								...
								<INPUT class=textbox id=manuf_serverip
														style="WIDTH: 180px" maxLength=50 name="manuf_serverip"  onfocus="showTips('manuf_serverip','ipv6地址必填！')" onblur="check3()"><span id="manuf_serveripspan"></span>
								</td>
								<td>公司联系人姓名：</td>
								<td>
								<INPUT class=textbox id=manuf_linkman style="WIDTH: 180px" maxLength=50 name="manuf_linkman" onfocus="showTips('manuf_linkman','联系人必填！')" onblur="check3()"><span id="manuf_linkmanspan"></span>
								</td>
							</TR>
							...
							<TR>
								...
								<INPUT class=textbox id=manuf_tel
														style="WIDTH: 180px" maxLength=50 name="manuf_tel"  onfocus="showTips('manuf_tel','联系电话必填！')" onblur="check3()"><span id="manuf_telspan"></span>
								</td>
								<td>公司电子邮箱：</td>
								<td>
								<INPUT class=textbox id=manuf_email
														style="WIDTH: 180px" maxLength=50 name="manuf_email" onfocus="showTips('manuf_email','公司邮箱必填！')" onblur="check3()"><span id="manuf_emailspan"></span>

...
<BODY>
	<FORM id=form2 name=form2 action="${pageContext.request.contextPath }/UsrinfoAction_update" method=post>
				...
				<TR>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						<TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
							<TR>
								<TD class=manageHead>当前位置：应用厂商信息 &gt; 修改应用厂商信息</TD>
							</TR>
							<TR>
								<TD height=2></TD>
							</TR>
						</TABLE>
							<s:iterator value="#list4" var="usr" >
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							...
							<td>应用厂家公司id：</td>
								<td>
								<INPUT class=textbox  style="WIDTH: 180px" maxLength=50 name="usr_id" id="usr_id" value=<s:property value="#usr.usr_id" />><span id="usr_namespan"></span>
								</td>
								<td>应用厂家公司全名：</td>
								<td>
								<INPUT class=textbox  style="WIDTH: 180px" maxLength=50 name="usr_name" id="usr_name" value=<s:property value="#usr.usr_name" /> onfocus="showTips('usr_name','应用厂家公司全名必填！')" onblur="check3()"><span id="usr_namespan"></span>
								</td>
								<td>公司地址：</td>
								<td>
								<INPUT class=textbox id="usr_addrs" style="WIDTH: 180px" maxLength=50 name="usr_addrs" value=<s:property value="#usr.usr_addrs" /> onfocus="showTips('usr_addrs','公司地址必填！')" onblur="check3()"><span id="usr_addrsspan"></span>
								</td>
							</TR>
							...
							<TR>
								...
								<INPUT class=textbox id=usr_serverip
														style="WIDTH: 180px" maxLength=50 name="usr_serverip"  value=<s:property value="#usr.usr_serverip" /> onfocus="showTips('usr_serverip','ipv6地址必填！')" onblur="check3()"><span id="usr_serveripspan"></span>
								</td>
								<td>公司联系人姓名：</td>
								<td>
								<INPUT class=textbox id=usr_linkman style="WIDTH: 180px" maxLength=50 name="usr_linkman" value=<s:property value="#usr.usr_linkman" /> onfocus="showTips('usr_linkman','联系人必填！')" onblur="check3()"><span id="usr_linkmanspan"></span>
								</td>
							</TR>
							...
							<TR>
								...
								<INPUT class=textbox id=usr_tel
														style="WIDTH: 180px" maxLength=50 name="usr_tel" value=<s:property value="#usr.usr_tel" /> onfocus="showTips('usr_tel','联系电话必填！')" onblur="check3()"><span id="usr_telspan"></span>
								</td>
								<td>公司电子邮箱：</td>
								<td>
								<INPUT class=textbox id=usr_email
														style="WIDTH: 180px" maxLength=50 name="usr_email" value=<s:property value="#usr.usr_email" /> onfocus="showTips('usr_email','公司邮箱必填！')" onblur="check3()"><span id="usr_emailspan"></span>
